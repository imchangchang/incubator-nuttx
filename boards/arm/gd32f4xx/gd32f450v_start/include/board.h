...
#define GPIO_UART4_RX_PORT GPIOE
#define GPIO_UART4_RX_PIN  GPIO_PIN_0
#define GPIO_UART4_RX_AF   GPIO_AF_8
#define GPIO_UART4_TX_PORT GPIOE
#define GPIO_UART4_TX_PIN  GPIO_PIN_1
#define GPIO_UART4_TX_AF   GPIO_AF_8
...
#define GPIO_I2C1_SCL_PIN  GPIO_PIN_10
#define GPIO_I2C1_SCL_AF   GPIO_AF_4
#define GPIO_I2C1_SDA_PORT GPIOB
#define GPIO_I2C1_SDA_PIN  GPIO_PIN_11
#define GPIO_I2C1_SDA_AF   GPIO_AF_4

#define GPIO_I2C2_SCL_PORT GPIOA
#define GPIO_I2C2_SCL_PIN  GPIO_PIN_8
#define GPIO_I2C2_SCL_AF   GPIO_AF_4
#define GPIO_I2C2_SDA_PORT GPIOC
#define GPIO_I2C2_SDA_PIN  GPIO_PIN_9
#define GPIO_I2C2_SDA_AF   GPIO_AF_4

#define GPIO_CAN0_RX_PORT GPIOD
#define GPIO_CAN0_RX_PIN  GPIO_PIN_0
#define GPIO_CAN0_RX_AF   GPIO_AF_9
#define GPIO_CAN0_TX_PORT GPIOD
#define GPIO_CAN0_TX_PIN  GPIO_PIN_1
#define GPIO_CAN0_TX_AF   GPIO_AF_9

#define GPIO_CAN1_RX_PORT GPIOB
#define GPIO_CAN1_RX_PIN  GPIO_PIN_12
#define GPIO_CAN1_RX_AF   GPIO_AF_9
#define GPIO_CAN1_TX_PORT GPIOB
#define GPIO_CAN1_TX_PIN  GPIO_PIN_13
#define GPIO_CAN1_TX_AF   GPIO_AF_9

/****************************************************************************
 * arch/arm/src/gd32f4xx/gd32_irq.c
 *
...
static int gd32_nmi(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int gd32_busfault(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int gd32_usagefault(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int gd32_pendsv(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int gd32_dbgmonitor(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int gd32_reserved(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
                         ...
                         uintptr_t offset)
{
  ...
  if (irq >= GD32_IRQ_FIRST)
    {
      n        = irq - GD32_IRQ_FIRST;
...
void up_irqinitialize(void)
{
  ...
  for (i = 0; i < NR_IRQS - GD32_IRQ_FIRST; i += 32)
    {
